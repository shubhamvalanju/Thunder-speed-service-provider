...
<html lang="en">
    <head>
        ...
        <title>DTH Between Dates Reports</title>
                    ...
                    <div class="container-xl px-4 mt-n10">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <div id="default">
                                    <div class="card mb-4">
                                        <div class="card-header">DTH Between Dates Reports</div>
                                        <div class="card-body">
                                            <!-- Component Preview-->
                                            <div class="sbp-preview">
                                                <div class="sbp-preview-content">
                                                    <form method="post" name="bwdatesreportdth" action="bwdates-report-detailsdthp.php">
