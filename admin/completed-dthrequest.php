...
<html lang="en">
    <head>
        ...
        <title>Completed DTH Request</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        <h1 class="page-header-title">
                                            ...
                                            Completed DTH Request
                                        </h1>
                                        <div class="page-header-subtitle">Completed DTH Request</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container-xl px-4 mt-n10">
                        <div class="card mb-4">
                            <div class="card-header">Completed DTH Request</div>
                            <div class="card-body">
