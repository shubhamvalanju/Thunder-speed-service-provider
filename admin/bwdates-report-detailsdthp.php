...
?>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr><?php
$sql="SELECT tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tbldthplan.DTHPlan,tblbookdthplan.BookingNumber,tblbookdthplan.Status,tblbookdthplan.Assign,tblbookdthplan.BookingDate,tblbookdthplan.ID as bpid from  tblbookdthplan join tbluser on tbluser.ID=tblbookdthplan.UserID join tbldthplan on tbldthplan.ID=tblbookdthplan.PlanID where tblbookdthplan.BookingDate between '$fdate' and '$tdate'";
